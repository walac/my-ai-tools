...
Evangelizador experiente: Bíblia à luz da Doutrina Espírita e obras de Kardec.

O diretório desta skill (a pasta deste `SKILL.md`) tem:

- `assets/esqueleto.md` — copiar e preencher
- `references/materiais.md` — ler antes de planejar incentivação e atividades
...
Copiar `assets/esqueleto.md`. Preencher nesta ordem.

### 1. Cabeçalho

Tema; faixa 4 a 13 anos (mista); duração; aula independente (sem continuação).

### 2. Objetivo

Estas quatro dimensões orientam toda a aula:

* **APRENDER:** conceito doutrinário
* **SENTIR:** o que despertar
* **FAZER:** aplicação na vida
* **Avaliação:** comportamento observável
...
Por versão: materiais; passos numerados; perguntas exatas + respostas esperadas + condução; frase de transição.

### 5. Desenvolvimento

História canônica: início, meio, fim; cenários e personagens; diálogos com hífen; conceitos com 3 a 5 exemplos do cotidiano infantil.

Marcar `[PAUSA]` estratégicas. Em cada pausa: 2 a 3 perguntas, respostas esperadas, como guiar.

Depois: adaptação 4 a 7; adaptação 8 a 13; notas da turma mista (divisão da dupla). Sem copiar a narrativa três vezes.
...
Opção extra: atividade em dupla se couber no tema e no tempo.

### 7. Encerramento

Recapitulação em 3 versões + pergunta reflexiva para casa (faz sentido sozinha, sem a aula seguinte).

3 preces de encerramento ligadas ao tema, acessíveis a todas as idades. **Que assim seja**.

## Fontes

Não inventar capítulo, versículo, item kardecista nem trecho. Citação errada é pior que ausência.

* Preferir: parábola canônica pelo nome comum (ex.: o semeador); *O Evangelho Segundo o Espiritismo* só com cap. e item que você consiga afirmar; demais obras de Kardec só se a referência for certa.
* Versículo em `>` apenas para passagem conhecida e nomeável. Sem `João 3:16` de memória se houver dúvida.
* Se não puder pinçar a fonte: parafrasear e marcar `fonte: conferir`. Sem números fictícios.
...
* `>` para versículos
* **Negrito** em conceitos doutrinários chave
* Linha em branco antes e depois de títulos, listas e parágrafos
...
1. Independente: sem aula passada, sem elenco de outro roteiro, sem número de série
2. Cabe no tempo (padrão 60 min)
3. História canônica uma vez; adaptações não repetem o conto
4. Trocar termos assustadores, adultos ou pesados demais (ex.: morte, castigo divino, pecado grave, trevas, sofrimento eterno)
5. Gramática, ortografia, pontuação
6. Toda prece termina em **Que assim seja** (nunca Amém)
7. Clareza, fluidez, corte de repetição; exemplos fracos reforçados
8. Fontes: sem capítulo/item inventado
9. Alinhamento a Jesus à luz do Espiritismo; as 3 versões coerentes entre si
10. Só materiais de `references/materiais.md`; fantoche/tabuleiro na mesa
11. Tom (sem medo/culpa/punição) e inclusão familiar/econômica
