...
Looking at the struct, a fake key is a counted switch. See kernel/fake_key.c.
...
[fake_key_enable()](https://elixir.bootlin.com/linux/v6.15/source/kernel/fake_key.c#L1) bumps a counter. Nested enables of [fake_key_enable()](https://elixir.bootlin.com/linux/v6.15/source/kernel/fake_key.c#L1) are covered in [](#does-not-exist){.secref}.
